...
# Edited by Jin Hyun Cheong to optionally solve for maximization.
...
#             preferences[person][j] = (num_preferences - rankings[person].index(j)) / float(num_preferences)
